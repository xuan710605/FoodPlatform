...
export interface ProductResult {total:number;page:number;page_size:number;items:CatalogProduct[]}
...
const mapProduct=(item:ApiProduct):CatalogProduct=>({
  id:item.id,
